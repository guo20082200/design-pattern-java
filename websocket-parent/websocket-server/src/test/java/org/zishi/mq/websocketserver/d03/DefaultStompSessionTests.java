...
public class DefaultStompSessionTests {
	...
	@Test
	void send() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
		...
		//List<String> nativeHeader = accessor.getNativeHeader("");

		MessageHeaders messageHeaders = accessor.getMessageHeaders();
		Map<String, List<String>> nativeHeaders = (Map<String, List<String>>) messageHeaders.get("nativeHeaders");
