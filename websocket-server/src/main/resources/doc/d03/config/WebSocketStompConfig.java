...
import org.zishi.mq.websocketserver.d03.handler.MyHandshakeHandler;
import org.zishi.mq.websocketserver.d03.interceptor.MyHandshakeInterceptor;
import org.zishi.mq.websocketserver.d03.interceptor.WebSocketUserInterceptor;
...
public class WebSocketStompConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        ...
        System.out.println("WebSocketStompConfig.configureMessageBroker");
        // 自定义调度器，用于控制心跳线程
    ...
    public void configureClientOutboundChannel(ChannelRegistration registration) {
        //System.out.println("WebSocketStompConfig.configureClientOutboundChannel");
        registration.taskExecutor().corePoolSize(100)
                .maxPoolSize(500)
                .keepAliveSeconds(60);
        //registration.interceptors(new WebSocketUserInterceptor());
